...
all:main 
# all:main pipe_line_server pollServer pollClient singleton_test guard_test

main: ActiveObject.c Queue.c ActiveObject.h Queue.h
	$(CC) $(FLAGS) -o test ActiveObject.c Queue.c
